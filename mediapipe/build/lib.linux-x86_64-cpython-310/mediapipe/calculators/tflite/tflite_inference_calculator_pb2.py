...
_TFLITEINFERENCECALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='try_mmap_model', full_name='mediapipe.TfLiteInferenceCalculatorOptions.try_mmap_model', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_gpu', full_name='mediapipe.TfLiteInferenceCalculatorOptions.use_gpu', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='use_nnapi', full_name='mediapipe.TfLiteInferenceCalculatorOptions.use_nnapi', index=3,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\030\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='cpu_num_thread', full_name='mediapipe.TfLiteInferenceCalculatorOptions.cpu_num_thread', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delegate', full_name='mediapipe.TfLiteInferenceCalculatorOptions.delegate', index=5,
