...
_TENSORCONVERTERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='gpu_origin', full_name='mediapipe.TensorConverterCalculatorOptions.gpu_origin', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_num_channels', full_name='mediapipe.TensorConverterCalculatorOptions.max_num_channels', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='row_major_matrix', full_name='mediapipe.TensorConverterCalculatorOptions.row_major_matrix', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_quantized_tensors', full_name='mediapipe.TensorConverterCalculatorOptions.use_quantized_tensors', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='output_tensor_float_range', full_name='mediapipe.TensorConverterCalculatorOptions.output_tensor_float_range', index=9,
...
_TENSORCONVERTERCALCULATOROPTIONS.fields_by_name['gpu_origin'].enum_type = mediapipe_dot_gpu_dot_gpu__origin__pb2._GPUORIGIN_MODE
