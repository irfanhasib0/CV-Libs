...
_GLSCALERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_nearest_neighbor_interpolation', full_name='mediapipe.GlScalerCalculatorOptions.use_nearest_neighbor_interpolation', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='use_input_format_for_output', full_name='mediapipe.GlScalerCalculatorOptions.use_input_format_for_output', index=8,
